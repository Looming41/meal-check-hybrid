...
export const DISEASES = [
  ...
  {
    id: 'prediab', name: '당뇨병 전단계·대사증후군', focus: '당류·탄수화물(완화 기준)',
  ...
  {
    id: 'migraine', name: '편두통', focus: '카페인·알코올·티라민',
    rules: [
  ...
  {
    id: 'insomnia', name: '불면증·수면장애', focus: '카페인·알코올',
    rules: [
  ...
  {
    id: 'pms', name: '생리전증후군(PMS)·생리통', focus: '나트륨·카페인',
    rules: [
      hi('sodium_mg', 700, 1200,
  ...
  {
    id: 'stones', name: '요로결석(신장결석)', focus: '나트륨·퓨린',
    rules: [
      hi('sodium_mg', 700, 1200,
  ...
  {
    id: 'oa', name: '퇴행성관절염(골관절염)', focus: '포화지방·당류(근거 약함)',
  ...
  {
    id: 'acne', name: '여드름·피부트러블', focus: '당류·유제품(근거 약함)',
    rules: [
      hi('sugar_g', 25, 40,
  ...
  {
    id: 'lactose', name: '유당불내증', focus: '유제품',
    rules: [],
    flags: [
      { when: n => n.tags.includes('dairy'), verdict: VERDICT.CAUTION,
  ...
  {
    id: 'celiac', name: '글루텐 민감증·셀리악병', focus: '밀·보리·호밀(글루텐)',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_peanut', name: '땅콩 알레르기', focus: '땅콩',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_treenut', name: '견과류 알레르기', focus: '호두·아몬드 등 견과류',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_shellfish', name: '갑각류·조개류 알레르기', focus: '새우·게·조개·오징어 등',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_egg', name: '계란 알레르기', focus: '계란',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_milk', name: '우유·유제품 알레르기', focus: '우유 단백질',
    rules: [],
    flags: [
  ...
  {
    id: 'allerg_soy', name: '대두(콩) 알레르기', focus: '대두·두부·된장 등',
    rules: [],
    flags: [
...
export const DISEASE_GROUPS = [
  ...
  { label: '대사',        ids: ['dm', 'prediab', 'nafld', 'gout'] },
  { label: '콩팥·요로',   ids: ['ckd', 'stones'] },
  { label: '뼈·피',       ids: ['osteo', 'anemia', 'thyroid'] },
  { label: '관절·피부',   ids: ['oa', 'acne'] },
  { label: '소화·삼킴',   ids: ['gerd', 'dysph', 'celiac', 'lactose'] },
  { label: '신경·수면',   ids: ['migraine', 'insomnia'] },
  { label: '약물·생리 상태', ids: ['warf', 'preg', 'pms'] },
  { label: '식품 알레르기', ids: ['allerg_peanut', 'allerg_treenut', 'allerg_shellfish', 'allerg_egg', 'allerg_milk', 'allerg_soy'] }
];
